...
class Actualizar():
    ...
    def update_function(self):
        ...
        self.cuadroNombre = Entry(self.top, textvariable = self.__miNombre)
        ...
        self.cuadroApellido = Entry(self.top, textvariable = self.__miApellido)
        ...
        self.cuadroTelefono = Entry(self.top, textvariable = self.__miNumero)
        ...
        self.cuadroDireccion = Entry(self.top, textvariable = self.__miDireccion)
        ...
        # boton leer
        self.botonLeer = Button(self.top, text = "Actualizar", command = lambda:objetoBD.actualizar(self.__miID, self.__miNombre, self.__miApellido, self.__miNumero, self.__miDireccion, self.__TextoComentario))
        self.botonLeer.place(x=180, y = 310, height=30, width=60)
